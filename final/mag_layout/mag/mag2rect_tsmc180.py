...
rect_map =  {
  ...
  'metal2'      :   ['m2'],
  'metal3'      :   ['m3'],
  'ndcontact'   :   ['ndcontact','ndiffusion', 'm1'],
  'ndc'         :   ['ndc','ndiffusion', 'm1'],
  'pdcontact'   :   ['pdcontact','pdiffusion', 'm1' ],
  'pdc'         :   ['pdc','pdiffusion', 'm1'],
  'polycontact' :   ['polycontact','polysilicon', 'm1'],
  'pc'          :   ['pc','polysilicon', 'm1' ],
  'm2contact'   :   ['m2c','m1','m2', 'v1'],
  'm2c'         :   ['m2c','m1','m2', 'v1'],
  'psubstratepdiff':['psubstratepdiff', 'ppdiff'],
  'psc'         :   ['psubstratepcontact', 'psc', 'ppdiff', 'm1' ],
  'nsubstratendiff':['nsubstratendiff', 'nndiff'],
  'nsc'         :   ['nsubstratencontact', 'nsc', 'nndiff', 'm1' ],
}
